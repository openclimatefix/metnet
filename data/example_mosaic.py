...
def main():
    ...
    print(
        f"   Output grid: {int((target_extent[2]-target_extent[0])/target_resolution)+1} × "
        f"{int((target_extent[3]-target_extent[1])/target_resolution)+1} pixels"
    )

    print("\n🚀 Creating mosaic...")
    print("   Note: First run may take ~30 minutes due to S3 data transfer")
    ...
    print("\n🎯 Next Steps:")
    print("   - Visualize the mosaic (e.g., using xarray.plot or matplotlib)")
    print("   - Verify spatial coverage and blending quality")
    print("   - Test with different timestamps")
    print("   - Add more bands as they become available")
